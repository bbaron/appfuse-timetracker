...
public class TimeUnit implements Comparable<TimeUnit>, Serializable, TimeUnitConversionFactors {
    ...
    static class Type implements Serializable {
        ...
        Type() {
         ...
         String getForPersistentMapping_Name() {
            return this.name;
        }
         void setForPersistentMapping_Name(String name) {
            this.name = name;
        }
    }
    int getFactor() {
    ...
    //Only for use by persistence mapping frameworks
    //<rant>These methods break encapsulation and we put them in here begrudgingly</rant>
     int getForPersistentMapping_Factor() {
        return factor;
    }
    //Only for use by persistence mapping frameworks
    //<rant>These methods break encapsulation and we put them in here begrudgingly</rant>
     void setForPersistentMapping_Factor(int factor) {
        this.factor = factor;
    }
    //Only for use by persistence mapping frameworks
    //<rant>These methods break encapsulation and we put them in here begrudgingly</rant>
