...
public class TimeOfDay {
    ...
    //Only for use by persistence mapping frameworks
    //<rant>These methods break encapsulation and we put them in here begrudgingly</rant>
     int getForPersistentMapping_Hour() {
        return hour.value();
    }
    //Only for use by persistence mapping frameworks
    //<rant>These methods break encapsulation and we put them in here begrudgingly</rant>
     void setForPersistentMapping_Hour(int hour) {
        this.hour = HourOfDay.value(hour);
    }
    //Only for use by persistence mapping frameworks
    //<rant>These methods break encapsulation and we put them in here begrudgingly</rant>
     int getForPersistentMapping_Minute() {
        return minute.value();
    }
    //Only for use by persistence mapping frameworks
    //<rant>These methods break encapsulation and we put them in here begrudgingly</rant>
     void setForPersistentMapping_Minute(int minute) {
        this.minute = MinuteOfHour.value(minute);
    }
