...
class FloatingDateSpecification extends AnnualDateSpecification {
    ...
    //Only for use by persistence mapping frameworks
    //<rant>These methods break encapsulation and we put them in here begrudgingly</rant>
    int getForPersistentMapping_DayOfWeek() {
        return dayOfWeek;
    }
    //Only for use by persistence mapping frameworks
    //<rant>These methods break encapsulation and we put them in here begrudgingly</rant>
    void setForPersistentMapping_DayOfWeek(int dayOfWeek) {
        this.dayOfWeek = dayOfWeek;
    }
    //Only for use by persistence mapping frameworks
    //<rant>These methods break encapsulation and we put them in here begrudgingly</rant>
    ...
    //Only for use by persistence mapping frameworks
    //<rant>These methods break encapsulation and we put them in here begrudgingly</rant>
    int getForPersistentMapping_Occurrence() {
        return occurrence;
    }
    //Only for use by persistence mapping frameworks
    //<rant>These methods break encapsulation and we put them in here begrudgingly</rant>
    void setForPersistentMapping_Occurrence(int occurrence) {
        this.occurrence = occurrence;
    }
}