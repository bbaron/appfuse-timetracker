...
public class Interval<T extends Comparable<T>> implements Comparable<Interval<T>>, Serializable {
    ...
    public static <U extends Comparable<U>> Interval<U> closed(U lower, U upper) {
        return new Interval<U>(lower, true, upper, true);
    }

    public static <U extends Comparable<U>> Interval<U> open(U lower, U upper) {
        return new Interval<U>(lower, false, upper, false);
    }

    public static <U extends Comparable<U>> Interval<U> over(U lower, boolean lowerIncluded, U upper, boolean upperIncluded) {
        return new Interval<U>(lower, lowerIncluded, upper, upperIncluded);
    }

    public static <U extends Comparable<U>> Interval<U> newInstance(U lower, boolean isLowerClosed, U upper, boolean isUpperClosed) {
        return new Interval<U>(lower, isLowerClosed, upper, isUpperClosed);
    }
    ...
    public T upperLimit() {
        return (T) upperLimitObject.getValue();
    }
   ...
   //Look for (or add) other methods to do computations.
    ...
    @SuppressWarnings("unchecked")
    public T lowerLimit() {
        return (T) lowerLimitObject.getValue();
    }
    ...
    public boolean covers(Interval<T> other) {
        int lowerComparison = lowerLimit().compareTo((T) other.lowerLimit());
