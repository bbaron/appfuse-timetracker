...
insert into users (first_name, last_name, username, password, enabled) values ('system', 'admin', 'admin', 'admin', 1); 
insert into users (first_name, last_name, username, password, enabled) values ('Naresh', 'Bhatia', 'nbhatia', 'nbhatia', 1); 
insert into users (first_name, last_name, username, password, enabled) values ('Louis', 'Coude', 'lcoude', 'lcoude', 0); 
...
insert into authorities(id, username, authority) values (3, 'admin', 'ROLE_APPROVER'); 
insert into authorities(id, username, authority) values (4, 'nbhatia', 'ROLE_USER'); 
insert into authorities(id, username, authority) values (5, 'nbhatia', 'ROLE_APPROVER'); 
insert into authorities(id, username, authority) values (6, 'lcoude', 'ROLE_USER'); 
insert into authorities(id, username, authority) values (7, 'ecrutchfield', 'ROLE_USER'); 
insert into authorities(id, username, authority) values (8, 'cmicali', 'ROLE_USER'); 
