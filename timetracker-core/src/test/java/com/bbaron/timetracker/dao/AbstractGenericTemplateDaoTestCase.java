 ...
 * @param <PK>
 */
public abstract class AbstractGenericTemplateDaoTestCase<T, PK extends Serializable> extends BaseDaoTestCase {
     ...
     */
    protected AbstractGenericTemplateDaoTestCase(Class<T> entityClass, PK validId, PK invalidId) {
        super();
