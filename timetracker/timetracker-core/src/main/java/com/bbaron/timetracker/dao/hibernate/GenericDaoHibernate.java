 ...
 * 
 * <pre>
 *      &lt;bean id=&quot;fooDao&quot; class=&quot;appfuse.example.dao.hibernate.GenericDaoHibernate&quot;&gt;
 *          &lt;constructor-arg value=&quot;appfuse.example.model.Foo&quot;/&gt;
...
public class GenericDaoHibernate<T, PK extends Serializable> extends HibernateDaoSupport implements GenericDao<T, PK> {
    ...
    public T save(T object) {
        T saved = (T) getHibernateTemplate().merge(object);
